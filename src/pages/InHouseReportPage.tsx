...
import { ChevronLeft, MapPin, History, Users, Coffee } from "lucide-react";
...
const columns: Column<InHouseRow>[] = [
  {
    key: "id",
    label: "Mã ĐK",
    sticky: true,
  ...
  { key: "arrivalDate", label: "Ngày đến", minWidth: 85 },
  { key: "departureDate", label: "Ngày đi", minWidth: 85 },
  {
    key: "nights",
    label: "Đêm",
    width: 45,
  ...
  { key: "pax", label: "Khách", width: 50, minWidth: 50, align: "center" },
  {
    ...
    render: (val) =>
      val ? (
        <Coffee className="w-3 h-3 text-emerald-500 mx-auto" />
      ) : (
